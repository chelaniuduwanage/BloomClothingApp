...
let productList = [
    ...
    Product(name: "Mock Item 2", category: "Tops", link1: "301101462_5117200571722084_6078220574943787059_n", link2: "", link3: "", description: "One of the primary functions of clothing is to protect the body from environmental elements such as weather, temperature extremes, and physical harm. Clothing acts as a barrier between the body and potentially harmful agents.", color: "Mock Color 2", itemSize: "Mock Size 2", price: 200),
